...
Pokemon.create!(name: "Alex", level: 89, hp: 4345, attack: 86, defense: 43, special_attack: 97, special_defense: 55, speed: 99, price: 589, user: User.all.sample, race: Race.find_by_name("pikachu"))
print "#"
puts ""
...
700.times do
  ...
  Review.create!(content: comment.sample, rating: rand(1..5), user: User.all.sample, pokemon: Pokemon.all.sample)
  print "#"
end
puts "#"  
